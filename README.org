...
Upon installation and upgrade of ~casual~, this package will be uninstalled from your Emacs configuration. Please revisit your configuration of Casual Bookmarks in your initialization file(s) accordingly.

This repository should be treated as an archive. All future development on Casual Bookmarks will be done in the [[https://github.com/kickingvegas/casual][Casual repository]].
