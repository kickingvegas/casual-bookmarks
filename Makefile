...
LISP_DIR=./lisp
MAIN_EL=$(LISP_DIR)/casual-bookmarks.el
VERSION_EL=$(LISP_DIR)/casual-bookmarks-version.el
...
bump-casual:
	...
	sed -i 's/(defconst casual-bookmarks-version "$(VERSION)"/(defconst casual-bookmarks-version "$(VERSION_BUMP)"/' $(VERSION_EL)
...
new-sprint: sync-development-with-main
	...
	sed -i 's/(defconst casual-bookmarks-version "$(VERSION)"/(defconst casual-bookmarks-version "$(VERSION_PRERELEASE)"/' $(MAIN_EL)
